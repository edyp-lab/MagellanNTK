...
#'
#' @noRd
mod_observe_dynamic_colourPicker_input_server <- function(id,
                                                          n = NULL,
                                                          label = NULL) {
  moduleServer(id, function(input, output, session) {
    ...
    output$dyn_inputs <- renderUI({
      ...
      # use a div with class = "dynamicSI"
      # to distinguish from other selectInput's
      div(
        class = "dynamicSI",
...
# mod_observe_dynamic_colourPicker_input_ui(
# "observe_dynamic_colourPicker_input_ui_1")

## To be copied in the server
# callModule(mod_observe_dynamic_colourPicker_input_server,
# "observe_dynamic_colourPicker_input_ui_1")
