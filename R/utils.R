...
#' * UI_view_debugger: a `boolean` to show (TRUE) of hide (FALSE) the debugger 
#' interface
#' * UI_view_open_pipeline: a `boolean` to show (TRUE) of hide (FALSE) the UI 
#' to open a pipeline
#' * UI_view_convert_dataset a `boolean` to show (TRUE) of hide (FALSE) the UI 
#' for convert/import a dataset
#' * UI_view_change_Look_Feel a `boolean` to show (TRUE) of hide (FALSE) the UI 
#' to change the L&F
#' * UI_view_change_core_funcs a `boolean` to show (TRUE) of hide (FALSE) the UI 
#' to change the generic functions
#' * extension A `character()` which specifies the extension file allowed to be 
#' processed
#' in the pipeline,
#' * class A `character()` which specifies the class of the dataset to be 
#' processed in the pipeline,
#' * package  A `character()` which specifies the package which owns the 
#' pipeline
...
#'
#' @param class A `character()` which is the class of the datasets one looking 
#' for
#' @param demo_package A `character()` which specifies a particular package to 
#' search
#'
...
#' of a pipeline and load into memory the source code of the R scripts (which 
...
#' @title Timestamp in UNIX format.
#'
#' @description Returns the date and time in timestamp UNIX format.
#'
#' @return A `integer()`.
#'
#' @examples
