...
#'                 text = "shinyjs.reset = function() {history.go(0)}",
#'                 functions = c("reset")
#'             ),
...
#'             )
#'             # navbarMenu("Help",
#'             #            tabPanel("Links",value="usefulLinksTab",  insert_md_ui(ns('links_MD'))),
#'             #            tabPanel("FAQ", value="faqTab",  insert_md_ui(ns('FAQ_MD'))),
