#' @title Shiny example process module `PipelineTemplate`
#'
#' @description
...
PipelineName_conf <- function(){
  MagellanNTK::Config(
    ...
    # Can be customized. Replace "PipelineName", by the name of your pipeline. Must begin
    ...
    # To indicate that the file is part of the PipelineName, their name is prefixed by 
    # th name of the pipeline
    # For this example below, there must exist the files:
    #   * PipelineName_Process1.R
...
#' @description 
#' Do not modify anything in this function. Just replace "PipelineName" in the name
#' of the function
#' 
#' @rdname modulePipeline
#' @export
