...
#' 
#' In this example, `PipelineDemo_DataGeneration_ui()` and `PipelineDemo_DataGeneration_server()` define
#' the code for the process `PipelineDemo_DataGeneration` which is part of the pipeline called `PipelineDemo`.
#' 
#' @examples 
#' if (interactive()){
#' library(MagellanNTK)
...
#' shiny::runApp(proc_workflowApp("PipelineDemo_DataGeneration", path, dataIn = lldata))
#' }
#' 
...
#' @export
#' 
PipelineDemo_DataGeneration_conf <- function(){
  MagellanNTK::Config(
...
#' @export
#'
PipelineDemo_DataGeneration_ui <- function(id){
  ns <- NS(id)
}
...
#' @export
#' 
PipelineDemo_DataGeneration_server <- function(id,
