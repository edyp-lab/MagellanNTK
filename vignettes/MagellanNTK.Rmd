...
La barré latérale à gauche contient les menus principaux. Elle se développe au passage du pointeur
de la souris dessus et se retracte sinon.
Les différents menus sont le ssuivants:
...
La partie centrale comprend trois espaces dédiés:
  ...
  * La partie en haut qui comprend trois boutons de navigation ('Backto start', 'Previous step' and
  'Next Step') et une timeline qui correspond à la succesion des étapes d'un 
  pipeline.
  * En dessous, se trouve la partie réservée aux processes et elle est également
  divisée en deux. Sur la gauche, une "sidebar" affiche
