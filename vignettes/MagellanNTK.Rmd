...
This tool is available when the user clicks on its icon, placed at the top right corner
of the screen. This action opens a modal window with 3 tabs, each of them
displaying an information about the dataset. The content of each of these 
panels is fully customizable by means of "generic functions" (See 'Inside MagellanNTK')


**Infos**: xxx
  * **history**: Displays the history stored in the current SE
  * **EDA**: 
