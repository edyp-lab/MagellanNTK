...
The package MagellanNTK is a Shiny application which provides the infrastructure for the
...
MagellanNTK is not strickly speaking a workflow in the sense that it do not
provide any data analysis tool but it is a workflow manager which offers 
many customization capabilities. It can deal with data formatted as
