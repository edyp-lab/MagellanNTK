...
The content of this part is updated each time tue user changes the current process.
...
```{r UI_PipelineDemo_Preprocessing2, results='markup', fig.cap="Sub-step Preprocessing/Filtering", echo=FALSE, out.width='100%', fig.align='center', fig.wide = TRUE}
...
```{r UI_PipelineDemo_Preprocessing3, results='markup', fig.cap="Sub-step Preprocessing/Normalization", echo=FALSE, out.width='100%', fig.align='center', fig.wide = TRUE}
...
```{r UI_PipelineDemo_Clustering2, results='markup', fig.cap="Sub-step Clustering/Clustering", echo=FALSE, out.width='100%', fig.align='center', fig.wide = TRUE}
knitr::include_graphics("./figs/UI_PipelineDemo_Clustering2.png", error = FALSE)
```
...
value as if it is the first time the user start this process.
